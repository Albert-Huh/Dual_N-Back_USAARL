...
class N_Back(object):
    ...
    def zeroBack(self):
        ...
        self.filename.write("Position Answer " + str(self.alpha_seq) + "\n")
        ...
        self.filename.write("Stabilization " + str(time.time() - stab_time) + " seconds" + "\n")
    ...
    def run(self):
        ...
        self.screen.blit(title, (125,0))
        pygame.event.get()
        description = "If you saw the same letter " + str(self.n) + " trials ago, you leftclick with the mouse. If you saw the same " \
                      "location " + str(self.n) + " trials ago, you rightclick with the mouse. If correct, you will hear 'good'. If you " \
...
class Session(object):
    def __init__(self, num_blocks, filename):
